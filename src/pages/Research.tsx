...
import { Youtube, ResearchGate, Google } from "lucide-react";
...
const researchPapers = [
  {
    ...
    videoLink: "http://tiny.cc/AMR-RT-1",
  ...
  },
  {
    ...
    videoLink: "http://tiny.cc/AMR-RT-2",
  ...
  },
  {
    ...
    videoLink: "http://tiny.cc/AMR-RT-3",
  ...
  },
  {
    ...
    videoLink: "http://tiny.cc/AMR-RT-4",
  ...
  return (
    <div className="section-container">
      ...
      <div className="flex gap-4 mb-8">
        ...
        <a 
          href="https://scholar.google.com/citations?user=uNLsfGIAAAAJ&hl=en" 
          target="_blank" 
          rel="noopener noreferrer"
          className="inline-flex items-center justify-center p-2 border-2 border-red-600 rounded-md hover:bg-red-100 transition-colors w-1/2"
          aria-label="Google Scholar"
        >
          <img 
            src="https://res.cloudinary.com/dav1ts03b/image/upload/v1746660572/Google_Scholar_logo_kt9bgv.webp" 
            alt="Google Scholar" 
            className="h-6 w-20" 
          />
          <span className="ml-2">Visit My Google Scholar Portfolio</span>
        </a>
        {/* ResearchGate Button */}
        <a 
          href="https://www.researchgate.net/profile/Mohd-Ammar?ev=hdr_xprf" 
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center justify-center p-2 bg-green-600 rounded-md hover:bg-green-700 transition-colors w-1/2"
          aria-label="ResearchGate"
        >
          <img 
            src="https://res.cloudinary.com/dav1ts03b/image/upload/v1746658762/ResearchGate_pnxb1c.webp" 
            alt="ResearchGate" 
            className="h-6 w-6" 
          />
          <span className="ml-2">Visit My Research Gate Page</span>
        </a>
      </div>
